...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addMartialArt(MartialArts martialArtsObject)
    {

        SQLiteDatabase database = getWritableDatabase();

        String addMartialArtSQLCommand = "insert into " + MARTIAL_ARTS_TABLE +
                " values(null, '" + martialArtsObject.getMartialArtName()
                + "', '" + martialArtsObject.getMartialArtPrice() +
                "', '" + martialArtsObject.getMartialArtColor() +
                "')";
    ...
    public ArrayList<MartialArts> returnAllMartialArtObjects(){
        ...
        while(cursor.moveToNext()){
            ...
            MartialArts currentMartialArtObject = new MartialArts(
    ...
    public MartialArts reutrnMartialArtsObjectByID(int id){
        ...
        MartialArts martialArtObject = null;


        if(cursor.moveToFirst()){


            martialArtObject = new MartialArts(Integer.parseInt(cursor.getString(0)),
