...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int martialArtBiuttonWidth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        martialArtBiuttonWidth = screenSize.x / 2;
    ...
    private void modifyUserInterface(){
        ...
        ArrayList<MartialArts> allMartialArtObjects = databaseHandler.returnAllMartialArtObjects();
        ...
        if(allMartialArtObjects.size() > 0){
            ...
            int index = 0;
            for(MartialArts martialArtsObject : allMartialArtObjects){

                martialArtButtons[index] = new MartialArtButton(MainActivity.this, martialArtsObject);

                martialArtButtons[index].setText(martialArtsObject.getMartialArtID() + "\n" +
                        martialArtsObject.getMartialArtName() + "\n" +
                        martialArtsObject.getMartialArtPrice() );

              switch (martialArtsObject.getMartialArtColor()){
              ...
              martialArtButtons[index].setOnClickListener(MainActivity.this);
                gridLayout.addView(martialArtButtons[index], martialArtBiuttonWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public void onClick(View view) {
        ...
        totalMartialArtPrice = totalMartialArtPrice + martialArtButton.getMatialArtPrice();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.add_martial_arts:
                Intent intent = new Intent(MainActivity.this, AddMartialArtsActivity.class);
